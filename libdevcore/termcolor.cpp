...
bool stdoutInitialized = initialize(STDOUT_FILENO);
...
bool initialize(int terminalFd)
{
	...
	static const array<HANDLE, 3> fdMap = { STD_INPUT_HANDLE, STD_OUTPUT_HANDLE, STD_ERROR_HANDLE };
	...
	HANDLE hOut = GetStdHandle(fdMap.at(terminalFd));
